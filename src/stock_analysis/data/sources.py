...
DATA_SOURCE_MATRIX: dict[str, list[SourceSpec]] = {
    "US": [
        SourceSpec(
            "Google Finance",
            GF_URL_TEMPLATE,
            ("price", "market_cap", "pe_ratio", "week52_low", "week52_high", "eps", "beta"),
            1,
        ),
        SourceSpec(
            "Yahoo Finance",
            "https://finance.yahoo.com/quote/{ticker}/key-statistics/",
            ("forward_pe", "peg_ratio", "pb_ratio", "beta"),
            2,
            "页面可能反爬；优先用 yfinance 程序化读取",
        ),
        SourceSpec(
            "StockAnalysis",
            "https://stockanalysis.com/stocks/{ticker}/statistics/",
            ("enterprise_value", "ev_ebit", "roic", "margins", "f_score"),
            3,
        ),
        SourceSpec(
            "MarketBeat",
            "https://www.marketbeat.com/stocks/{exchange}/{ticker}/",
            ("price_target", "analyst_rating", "ytd_change_pct"),
            4,
        ),
        SourceSpec(
            "SEC/company IR",
            "company filings / investor relations",
            ("revenue", "ebit", "net_income", "cash_flow", "debt", "equity"),
            5,
        ),
    ],
    "HK": [
        ...
        SourceSpec(
            "MarketScreener",
            "https://www.marketscreener.com/search/?q={ticker}",
            ("price_target", "consensus", "enterprise_value", "pb_ratio"),
            3,
        ),
        SourceSpec(
            "HKEXnews",
            "https://www.hkexnews.hk/search/titlesearch.xhtml?lang=en",
            ("annual_report", "interim_report", "cash_flow", "debt", "equity"),
            4,
            "发行人披露为准，PDF/HTML 可由 LLM webfetch 抽表",
        ),
    ...
    "JP": [
        ...
        SourceSpec(
            "Yahoo Finance",
            "https://finance.yahoo.com/quote/{ticker}.T/key-statistics/",
            ("forward_pe", "peg_ratio", "pb_ratio", "beta"),
            2,
        ),
        SourceSpec(
        ...
        SourceSpec(
            "EDINET",
            "https://disclosure2.edinet-fsa.go.jp/weee0060.aspx",
            ("xbrl", "financial_statements", "cash_flow", "debt", "equity"),
            4,
            "英文 XBRL 仅辅助，日文原文为准",
        ),
        SourceSpec("Company IR", "company investor relations", ("revenue", "ebit", "net_income", "capex", "shares"), 5),
    ...
    "KR": [
        ...
        SourceSpec(
            "Yahoo Finance",
            "https://finance.yahoo.com/quote/{ticker}.KS/key-statistics/",
            ("forward_pe", "peg_ratio", "pb_ratio", "beta"),
            2,
        ),
        SourceSpec(
        ...
        SourceSpec(
            "DART/OpenDART",
            "https://englishdart.fss.or.kr/mainEng.do",
            ("xbrl", "financial_statements", "cash_flow", "debt", "equity"),
            4,
            "英文披露仅辅助，韩文/XBRL 为准",
        ),
    ...
    "CN": [
        ...
        SourceSpec(
            "yfinance",
            "programmatic API",
            ("forward_pe", "peg_ratio", "enterprise_value", "beta", "financial_ratios"),
            2,
            "688256.SS 返回完整 info + BS/IS/CF",
        ),
        SourceSpec(
            "MarketScreener",
            "https://www.marketscreener.com/search/?q={ticker}",
        ...
        SourceSpec(
            "Company IR", "cambricon.com investor relations", ("revenue", "ebit", "net_income", "capex", "shares"), 5
        ),
    ],
    "CRYPTO_BTC": [
        SourceSpec(
            ...
            ("price", "market_cap", "volume", "circulating_supply", "total_supply"),
            1,
        ),
        SourceSpec(
            "mempool.space", "https://mempool.space/api/v1/...", ("hash_rate", "fees", "mempool", "network_health"), 2
        ),
        SourceSpec(
            "blockchain.com charts",
            "https://api.blockchain.info/charts/{chart}?format=json",
            ("transactions", "active_addresses_proxy", "fees"),
            3,
        ),
        SourceSpec(
            "LookIntoBitcoin",
            "https://www.lookintobitcoin.com/charts/",
            ("mvrv_z_score", "nvt", "cycle_indicators"),
            4,
            "公开图表优先，非稳定 API",
        ),
    ...
    "CRYPTO_POS": [
        ...
        SourceSpec(
            "DeFiLlama fees", "https://api.llama.fi/overview/fees/{slug}", ("fees", "revenue", "holders_revenue"), 3
        ),
        SourceSpec(
            "Chain explorer / staking dashboard",
            "chain-specific public pages",
            ("staking_ratio", "validators", "active_addresses"),
            4,
        ),
